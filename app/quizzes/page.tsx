...
export const metadata: Metadata = {
  ...
  description: 'Descubra seu tipo de pele, procedimentos ideais e rotina de skincare personalizada. Quizzes interativos da Clínica da Fefe.',
};
      ...
      <div className="modal" id="quizModal">
        <div className="modal-content">
          ...
          <div className="navigation" id="navigationButtons" style={{ display: 'none' }}>
            <button className="btn-nav btn-secondary" onClick="previousQuestion()" style={{ display: 'none' }} id="prevBtn">
              ← Anterior
            </button>
            <span className="nav-info" id="questionCounter"></span>
            <button className="btn-nav btn-secondary" onClick="nextQuestion()" style={{ display: 'none' }} id="nextBtn">
              Próxima →
            </button>
          </div>
                ...
                results: {
                    0: {
                        ...
                        products: [
                            ...
                            'Procedimentos: <a href="/procedimentos/facial/microagulhamento-facial">Microagulhamento</a>, <a href="/procedimentos/facial/peeling-facial">Peeling Facial</a>, <a href="/procedimentos/facial/skinbooster">Skinbooster</a>'
                        ],
                    ...
                    1: {
                        ...
                        products: [
                            ...
                            'Procedimentos: <a href="/procedimentos/facial/hidratacao-profunda">Hidratação Profunda</a>, <a href="/procedimentos/facial/skinbooster">Skinbooster</a>, <a href="/procedimentos/facial/rejuvenescimento">Rejuvenescimento</a>'
                        ],
                    ...
                    2: {
                        ...
                        products: [
                            ...
                            'Procedimentos preventivos: <a href="/procedimentos/facial/botox">Botox</a>, <a href="/procedimentos/facial/bioestimulador-facial">Bioestimulador</a>, <a href="/procedimentos/facial/skinbooster">Skinbooster</a>'
                        ],
                        articleLink: '/blog'
                    },
                    3: {
                        ...
                        products: [
                            ...
                            'Procedimentos: <a href="/procedimentos/facial/skinbooster">Skinbooster</a>, <a href="/procedimentos/facial/hidratacao-profunda">Hidratação Profunda</a>'
                        ],
            ...
            'procedure-facial': {
                ...
                results: {
                    0: {
                        ...
                        products: [
                            '<a href="/procedimentos/facial/botox">Botox</a> - Prevenção e tratamento de rugas',
                            '<a href="/procedimentos/facial/bioestimulador-facial">Bioestimulador</a> - Estimulação de colágeno próprio',
                            ...
                            '<a href="/procedimentos/pele/soroterapia">Soroterapia</a> - Terapia celular avançada'
                        ],
                    ...
                    1: {
                        ...
                        products: [
                            ...
                            '<a href="/procedimentos/facial/preenchimento-mandibula">Preenchimento de Mandíbula</a> - Definição do contorno',
                            '<a href="/procedimentos/facial/bioestimulador-facial">Bioestimulador</a> - Restauração de volume'
                        ],
                    ...
                    2: {
                        ...
                        products: [
                            ...
                            '<a href="/procedimentos/facial/fios-pdo">Fios de PDO com Sustentação</a> - Sustentação facial natural'
                        ],
                        articleLink: '/procedimentos/facial'
                    },
                    3: {
                        ...
                        products: [
                            '<a href="/procedimentos/facial/cicatrizes-acne">Tratamento de Cicatrizes de Acne</a> - Suavização de marcas',
                            '<a href="/procedimentos/facial/peeling-facial">Peeling Facial</a> - Renovação da pele',
                            '<a href="/procedimentos/facial/intradermoterapia">Intradermoterapia</a> - Microinjeções terapêuticas',
                            '<a href="/procedimentos/pele/manchas-melasma">Tratamento de Manchas</a> - Remoção de manchas',
                            '<a href="/procedimentos/facial/hidratacao-profunda">Hidratação Profunda</a> - Restauração de umidade'
                        ],
                        articleLink: '/procedimentos/facial'
                    }
                }
                ...
                results: {
                    0: {
                        ...
                        products: [
                            ...
                            '<a href="/procedimentos/corporal/lipo-papada">Lipo Enzimática para Papada</a> - Definição do queixo',
                            '<a href="/procedimentos/corporal/perda-peso">Tratamento para Perda de Peso</a> - Protocolo completo'
                        ],
                    ...
                    1: {
                        ...
                        products: [
                            '<a href="/procedimentos/corporal/bioestimulador-corporal">Bioestimulador Corporal</a> - Estimulação de colágeno',
                            '<a href="/procedimentos/corporal/skinbooster">Skinbooster Corporal</a> - Hidratação profunda',
                            '<a href="/procedimentos/corporal/peeling-corporal">Peeling Corporal</a> - Renovação de pele',
                            '<a href="/procedimentos/pele/soroterapia">Soroterapia</a> - Terapia celular avançada'
                        ],
                        articleLink: '/procedimentos/corporal'
                    },
                    2: {
                        ...
                        products: [
                            '<a href="/procedimentos/corporal/subcisao-celulite">Subcisão de Celulite</a> - Elevação de depressões',
                            '<a href="/procedimentos/pele/estrias">Tratamento de Estrias</a> - Suavização e renovação',
                            '<a href="/procedimentos/corporal/microagulhamento-corporal">Microagulhamento Corporal</a> - Estimulação de reparo',
                            '<a href="/procedimentos/areas-sensiveis/peeling-intimo">Peeling Íntimo</a> - Clareamento de manchas'
                        ],
                        articleLink: '/procedimentos/corporal'
                    },
                    3: {
                        ...
                        products: [
                            '<a href="/procedimentos/corporal/preenchimento-gluteos">Preenchimento de Glúteos</a> - Aumento e definição',
                            '<a href="/procedimentos/corporal/fios-pdo">Fios de PDO com Sustentação</a> - Sustentação corporal',
                            '<a href="/procedimentos/corporal/bioestimulador-corporal">Bioestimulador Corporal</a> - Restauração de volume',
                            '<a href="/procedimentos/corporal/flacidez-corporal">Flacidez Corporal</a> - Firmeza e sustentação'
                        ],
                        articleLink: '/procedimentos/corporal'
                    }
                }
